...
def inference(args, rank, select_test_datas):
    ...
    for data in select_test_datas:
        ...
        color_cond = extract_and_encode_brightness_from_image(t_img_path).to(device)
