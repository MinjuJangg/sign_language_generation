...
from src.dataset.stage2_dataset_ori import InpaintDataset, InpaintCollate_fn
...
def main():
    ...
    if accelerator.is_main_process:
        ...
        accelerator.init_trackers(
            project_name=args.project_name,  # wandb 프로젝트 이름
    ...
    unet = Stage2_InapintUNet2DConditionModel.from_pretrained(args.pretrained_model_name_or_path, subfolder="unet",
                                                   in_channels=9, class_embed_type=None ,projection_class_embeddings_input_dim=None,
                                                  low_cpu_mem_usage=False, ignore_mismatched_sizes=True,class_labels=None )
